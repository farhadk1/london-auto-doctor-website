    ...
    <Bounded className="bg-automotive-hero">
      <div className="text-center space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {/* Phone */}
          <div className="bg-card rounded-lg p-6 text-center space-y-3 border border-border hover:border-automotive-orange/50 transition-colors">
            <div className="w-12 h-12 rounded-full bg-automotive-orange/10 flex items-center justify-center mx-auto">
          ...
          {/* Hours */}
          <div className="bg-card rounded-lg p-6 text-center space-y-3 border border-border">
            <div className="w-12 h-12 rounded-full bg-automotive-orange/10 flex items-center justify-center mx-auto">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground space-y-1">
                ...
                <div className="text-automotive-orange font-semibold">Emergency: 24/7</div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button 
            asChild 
            size="lg" 
            className="bg-automotive-orange hover:bg-automotive-orange/90 text-white font-semibold px-8"
          >
        ...
        {/* Trust Indicators */}
        <div className="flex flex-wrap justify-center items-center gap-6 text-sm text-muted-foreground pt-6 border-t border-border/40">
